        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('dosen.homeDosen')}}" class="site_title"><i class="fa fa-code"></i> <span>Course Learning System</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="{{ url('dosen.homeDosen')}}"><i class="fa fa-home"></i> Home </a></li>
                  ...
                  <li><a href="{{ url('/tournamentDosen')}}"><i class="fa fa-cubes"></i> Tournament </a></li>
                  ...
                  <li><a href="{{ url('/forecastingDosen')}}"><i class="fa fa-line-chart"></i> Forcasting </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="{{url('/profile')}}" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{URL('images/user.png')}}" alt="">{{Session::get('login')}}
          ...
          <div class="">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="{{URL::asset('images/1.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/3.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/4.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/5.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/6.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/1.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/3.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/4.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/5.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/6.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/1.jpg')}}" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="{{URL::asset('images/2.jpg')}}" width="100%" height="100%"></div>
                </div>
                <!-- Add Pagination -->
