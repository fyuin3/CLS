...
<head>
  ...
  <link rel="stylesheet" href="vendors/bower_components/fullcalendar/dist/fullcalendar.print.min.css" media="print">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="images/index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>CLS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Course Learning System</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Steven Yong</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
<!-- jQuery UI 1.11.4 -->
<script src="vendors/bower_components/jquery-ui/jquery-ui.min.js"></script>
<!-- Slimscroll -->
...
<!-- fullCalendar -->
<script src="vendors/bower_components/moment/moment.js"></script>
