                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                          ...
                          <table id="datatable-keytable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($bank as $b): ?>
                                    <tr>
                                      <td><?php echo e($b->namaSoal); ?></td>
                                      <td><?php echo e($b->pembuat); ?></td>
                                      <td><?php echo e(date('d-M-Y', strtotime($b->tahunTerbit))); ?></td>
                                      <td><?php echo e($b->tipeSoal); ?></td>
                                      <td><?php echo e($b->jumlahSoal); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                          ...
                          <form method="POST" action="<?php echo e(url('/bankSoalDosen')); ?>" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate>
