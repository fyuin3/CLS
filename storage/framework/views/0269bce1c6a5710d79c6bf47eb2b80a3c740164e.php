                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo e(url('/projectDetail')); ?>" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                            <a href="<?php echo e(url('/projectDetail')); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="<?php echo e(url('/projectDetail')); ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        <tr>
                          <td>#</td>
