          ...
          <section class="login_content">
            <form action="<?php echo e(url('/login')); ?>" method="POST">
              ...
              <div align="right">
                ...
                <a class="btn btn-default submit" href="<?php echo e(url('/home')); ?>">Log in</a>
              </div>
              ...
              <h1>Create Account</h1>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nrp" class="form-control col-md-7 col-xs-12" data-validate-length-range="7" data-validate-words="1" name="nrp" placeholder="1472088" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="name" placeholder="name(s) e.g Steven Yong" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control" required="required" id="prodi" name="prodi">
                            ...
                            <optgroup label="Fakultas Kedokteran">
                              <option value="">Pendidikan Dokter</option>
                              <option value="">Profesi Dokter</option>
                            </optgroup>

                            <optgroup label="Fakultas Teknik">
                              <option value="">S-1 Teknik Sipil</option>
                              <option value="">S-1 Teknik Elektro</option>
                              <option value="">S-1 Teknik Industri</option>
                              <option value="">S-1 Sistem Komputer</option>
                            </optgroup>

                            <optgroup label="Fakultas Psikologi">
                              <option value="">S-1 Psikologi</option>
                              <option value="">S-2 Psikologi Sains</option>
                              <option value="">S-2 Psikologi Profesi</option>
                            </optgroup>

                            <optgroup label="Fakultas Sastra">
                              <option value="">D-III Bahasa Mandarin</option>
                              <option value="">S-1 Sastra Inggris</option>
                              <option value="">S-1 Sastra Jepang</option>
                              <option value="">S-1 Sastra Cina</option>
                            </optgroup>

                            <optgroup label="Fakultas Ekonomi">
                              <option value="">S-1 Akuntansi</option>
                              <option value="">S-1 Manajemen</option>
                              <option value="">S-2 Manajemen</option>
                            </optgroup>

                            <optgroup label="Fakultas Seni Rupa dan Desain">
                              <option value="">D-III Seni Rupa dan Desain</option>
                              <option value="">S-1 Seni Murni</option>
                              <option value="">S-1 Desain Interior</option>
                              <option value="">S-1 Desain Komunikasi Visual</option>
                            </optgroup>

                            <optgroup label="Fakultas Teknologi Informasi">
                              <option value="">S-1 Teknik Informatika</option>
                              <option value="">S-1 Sistem Informasi Bisnis</option>
                            </optgroup>

                            <optgroup label="Fakultas Hukum">
                              <option value="">S-1 Ilmu Hukum</option>
                            </optgroup>

                            <optgroup label="Fakultas Kedokteran Gigi">
                              <option value="">Pendidikan Dokter Gigi</option>
                              <option value="">Profesi Dokter Gigi</option>
                            </optgroup>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tanggalLahir">Tanggal Lahir
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class='input-group date' id='tanggalLahir'>
                              <input type='text' class="optional form-control col-md-7 col-xs-12" readonly="readonly" />
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="website">Stream Link
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="url" id="website" name="website"  placeholder="https://gaming.youtube.com/channel/UCdjcM0dxFRLvVtGTBlv5Q0Q/live" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel" id="telephone" name="phone" required="required" data-validate-length-range="8,20" placeholder="081221669924" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">About
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
