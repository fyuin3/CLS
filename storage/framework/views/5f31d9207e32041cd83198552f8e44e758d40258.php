        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo e(url('dosen.homeDosen')); ?>" class="site_title"><i class="fa fa-code"></i> <span>Course Learning System</span></a>
            </div>
            ...
            <!-- menu profile quick info -->
              <div class="profile clearfix">
                <div class="profile_pic">
                  <img src="<?php echo e(URL::asset('images/user.png')); ?>" alt="..." class="img-circle profile_img">
                </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo e(url('dosen.homeDosen')); ?>"><i class="fa fa-home"></i> Home </a></li>
                  ...
                  <li><a href="<?php echo e(url('/forecastingDosen')); ?>"><i class="fa fa-line-chart"></i> Forcasting </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="<?php echo e(url('/profile')); ?>" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e(URL('images/user.png')); ?>" alt=""><?php echo e(Session::get('login')); ?>
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="<?php echo e(URL('images/user.png')); ?>" alt="Profile Image" /></span>
                        <span>
                          <span><?php echo e(Session::get('login')); ?></span>
          ...
          <div class="">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/1.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/3.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/4.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/5.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/6.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/1.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/3.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/4.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/5.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/6.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/1.jpg')); ?>" width="100%" height="100%"></div>
                    <div class="swiper-slide"><img src="<?php echo e(URL::asset('images/2.jpg')); ?>" width="100%" height="100%"></div>
                </div>
                <!-- Add Pagination -->
            ...
            <!-- Swiper JS -->
            <script src="<?php echo e(asset('vendors/dist/js/swiper.min.js')); ?>"></script>
